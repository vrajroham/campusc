...
<!-- complete html file will be sent as email body -->
                                ...
                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                    <tr>
                                        <td style="padding: 40px; text-align: left; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;">
                                            ...
                                            Your account towards campusc is successfully created by college <b><i>Sanjivani College of Engineering, Kopargaon.</i></b> To complete signup process follow the steps.<br><br>
                                            <i>{More Information Goes Here}</i>
                                            <br><br>
                                            Click the following button to complete your registration.
                                            <br><br>
                                            <!-- Button : Begin -->
                                            <table cellspacing="0" cellpadding="0" border="0" align="center" style="Margin: auto">
                                                <tr>
                                                    <td style="border-radius: 3px; background: #222222; text-align: center;" class="button-td">
                                                        <a href="{{route("student/verification")}}/{{$row['token']}}" style="background: #222222; border: 15px solid #222222; padding: 0 10px;color: #ffffff; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 680px;">
                        <tr>
                            <td style="padding: 40px 10px;width: 100%;font-size: 12px; font-family: sans-serif; mso-height-rule: exactly; line-height:18px; text-align: center; color: #888888;">
                                ...
                                <br><br>
                                Campusc<br><span class="mobile-link--footer">123 Fake Street, Mumbai, MH, 97477 IN</span><br><span class="mobile-link--footer">(123) 456-7890</span>
                                <br><br>

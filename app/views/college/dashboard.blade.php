        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Students registered with  their details</p>
                    <hr class="tall">
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <h4><i class="fa fa-tasks"></i><b> Manage Student Records</b></h4>
                                ...
                                <div class="panel-body">
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            <td>1</td>
                                            <td>SRES-1234</td>
                                            <td><a href="college.student-info">Vaibhavraj Roham</a></td>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse1Two">
                                        <i class="fa fa-user-plus"></i>   Rejected Submissions
                                        <label class="label label-danger pull-right">2 New Request(s)</label>
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse1Three">
                                        <i class="fa fa-user-plus"></i> Re-Submitted Submissions
                                        <label class="label label-danger pull-right">2 New Request(s)</label>
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse1Four">
                                        <i class="fa fa-user-plus"></i> Approved Submissions
                                        <label class="label label-danger pull-right">2 New Request(s)</label>
                                    </a>
                                </h4>
                            </div>

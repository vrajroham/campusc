                ...
                <div class="col-md-12">
                   <table class="table table-condensed table-bordered text-center">
                       <tr class="alert alert-warning">
                        ...
                        <?php $i=1;?> <!-- init i from 1 for just counting -->
                       <!-- repeat for all rows from sheet -->
                    ...
                    {{Form::hidden("result",$result)}} <!-- took a hidden element to hold all rows for passing to next form -->
                    <p>
